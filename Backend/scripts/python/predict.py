#!/usr/bin/env python3
"""
PawPal Backend - Python Bridge for Dog Breed Prediction
...
# Add the ML_Models path to sys.path to import our modules
...
class DogBreedPredictor:
    def __init__(self, model_path, class_names_path, use_gpu=True, use_tta=True):
