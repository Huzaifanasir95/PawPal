...
print(f"\n{'='*70}")
print(f"🚀 STARTING 4-STAGE PROGRESSIVE TRAINING ON KAGGLE")
print(f"{'='*70}\n")
...
total_layers = len(list(actual_model.named_parameters()))
unfreeze_from = int(total_layers * 0.75)

for idx, (name, param) in enumerate(actual_model.named_parameters()):
...
print(f"\n{'='*70}")
print(f"🎉 TRAINING COMPLETED ON KAGGLE!")
print(f"{'='*70}")
print(f"📊 Best Validation Accuracy: {best_accuracy:.2f}%")
print(f"📁 Model saved to: /kaggle/working/ (auto-saved for 20 days!)")
print(f"{'='*70}\n")
...
print("✅ Training history and class names saved to /kaggle/working/")
print("💡 Files will be available in the notebook output panel!")
